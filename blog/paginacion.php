...
<?php for ($i = 1; $i <= $numero_paginas; $i++ ): ?>
  <!-- que la variable i igual a 1, quiero que el siclo se repita mientras que $i sea igualo o menor al numero de paginas que tenemos y que en cada ejecucion $i incremente una unidad -->
